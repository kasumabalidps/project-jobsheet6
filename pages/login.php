    ...
    <div class="flex w-full max-w-4xl shadow-md">
        <div class="flex flex-col justify-center bg-white rounded-l-md form-container form">
            <div class="text-center">
                <h1 class="text-2xl font-bold pb-2">Selamat Datang Kembali!!</h1>
            ...
            <form>
                ...
                <div class="mb-3">
                    <button type="submit" class="block w-full px-4 py-2 text-center text-white bg-black custom-button hover:bg-gray-800">Masuk</button>
                </div>
                <div class="text-center">
